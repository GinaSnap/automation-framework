...
public class TestCreateMealPlan extends MobileTestCase {
	...
	public void testCreateNewMealPlan_Whole30_1500_5Day()
	{
		...
		MealPlanningPage mealPlanningPage = new MealPlanningPage();
		assertEquals("Verify:  Create Meal Plan High Protein, 1200, 3 Days, Pickup.", "Success", mealPlanningPage.createMealPlan(newUser, PlanType.WHOLE30, Size.SMALL, DaysPerWeek.THREE_DAYS, Fulfillment.PICKUP, DayParts.BREAKFAST, DayParts.LUNCH, DayParts.DINNER));
